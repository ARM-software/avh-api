...
with avh_api.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = arm_api.ArmApi(api_client)
    web_player_create_session_request = WebPlayerCreateSessionRequest(
...
with avh_api.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = arm_api.ArmApi(api_client)
    session_id = "sessionId_example" # str | Web Player Session identifier
...
> [WebPlayerSession] v1_web_player_list_sessions()
