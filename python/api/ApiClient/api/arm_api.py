...
from ApiClient.api_client import ApiClient, Endpoint as _Endpoint
...
class ArmApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.v1_users_login_endpoint = _Endpoint(
            settings={
                'response_type': (Token,),
                'auth': [],
                'endpoint_path': '/v1/users/login',
                'operation_id': 'v1_users_login',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def v1_users_login(
        ...
        **kwargs
        ...
        kwargs['credentials'] = \
            credentials
        return self.v1_users_login_endpoint.call_with_http_info(**kwargs)
