...
If the OpenAPI document is large, imports in AvhClient.apis and AvhClient.models may fail with a
RecursionError indicating the maximum recursion limit has been exceeded. In that case, there are a couple of solutions:

Solution 1:
Use specific imports for apis and models like:
- `from AvhClient.api.default_api import DefaultApi`
- `from AvhClient.model.pet import Pet`
...
import AvhClient
from AvhClient.apis import *
from AvhClient.models import *
```
