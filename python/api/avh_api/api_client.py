...
from avh_api import rest
from avh_api.configuration import Configuration
from avh_api.exceptions import ApiTypeError, ApiValueError, ApiException
from avh_api.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __gather_params(self, kwargs):
        ...
        for param_name, param_value in kwargs.items():
            ...
            if param_location is None:
                continue
            param_type = self.openapi_types[param_name]
            if param_location:
                ...
                if (param_location == 'form' and (
                        param_type == (file_type,) or 
                        ( param_type == (file_type, type(None)) and param_value != None )
                        )):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = ArmApi()
        api_instance.trial_status  # this is an instance of the class Endpoint
        api_instance.trial_status()  # this invokes api_instance.trial_status.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.trial_status.callable or self.callable in this class
