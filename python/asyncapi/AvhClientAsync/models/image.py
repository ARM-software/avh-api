...
class Image(object):
    ...
    def type(self, type):
        ...
        :type type: str
        """
        allowed_values = [None,"iotfirmware", "kernel", "devicetree", "ramdisk", "loaderfile", "sepfw", "seprom", "bootrom", "llb", "iboot", "ibootdata", "fw", "partition/  * @property {string} self"]  # noqa: E501
