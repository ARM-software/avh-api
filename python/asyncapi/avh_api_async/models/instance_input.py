...
class InstanceInput(object):
    ...
    def __init__(self, position=None, start=None, end=None, text=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def text(self):
        """Gets the text of this InstanceInput.  # noqa: E501

        text to type  # noqa: E501

        :return: The text of this InstanceInput.  # noqa: E501
        :rtype: str
        """
        return self._text
    ...
    @text.setter
    def text(self, text):
        """Sets the text of this InstanceInput.

        text to type  # noqa: E501

        :param text: The text of this InstanceInput.  # noqa: E501
        :type text: str
        """
