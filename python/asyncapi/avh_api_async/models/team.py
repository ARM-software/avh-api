...
class Team(object):
    ...
    def __init__(self, id=None, label=None, users=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def label(self):
        """Gets the label of this Team.  # noqa: E501

        Team Label  # noqa: E501

        :return: The label of this Team.  # noqa: E501
        :rtype: str
        """
        return self._label
    ...
    def label(self, label):
        """Sets the label of this Team.

        Team Label  # noqa: E501

        :param label: The label of this Team.  # noqa: E501
        :type label: str
        """
