...
from avh_api_async.exceptions import (  # noqa: F401
    ApiTypeError,
    ApiValueError
)
...
class ArmApi(object):
    ...
    def trial_status(self, trial_email, **kwargs):  # noqa: E501
        ...
        :param trial_email: Trial Email (required)
        :type trial_email: str
        ...
        return self.trial_status_with_http_info(trial_email, **kwargs)  # noqa: E501

    def trial_status_with_http_info(self, trial_email, **kwargs):  # noqa: E501
        """Get Trial Status  # noqa: E501
        ...
        >>> thread = api.trial_status_with_http_info(trial_email, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method trial_status" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'trial_email' is set
        if self.api_client.client_side_validation and local_var_params.get('trial_email') is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `trial_email` when calling `trial_status`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'trial_email' in local_var_params:
            path_params['trialEmail'] = local_var_params['trial_email']  # noqa: E501
    ...
    def v1_add_project_key_with_http_info(self, project_id, project_key, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and local_var_params.get('project_key') is None:  # noqa: E501
    ...
    def v1_add_team_role_to_project(self, project_id, team_id, role_id, **kwargs):  # noqa: E501
        ...
        :type team_id: str
        :param role_id: Role ID - uuid (required)
        :type role_id: str
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
    ...
    def v1_add_team_role_to_project_with_http_info(self, project_id, team_id, role_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and local_var_params.get('team_id') is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `team_id` when calling `v1_add_team_role_to_project`")  # noqa: E501
        # verify the required parameter 'role_id' is set
        if self.api_client.client_side_validation and local_var_params.get('role_id') is None:  # noqa: E501
    ...
    def v1_auth_login(self, api_token, **kwargs):  # noqa: E501
        """Log In  # noqa: E501
        ...
        :param api_token: Authorization Data (required)
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.v1_auth_login_with_http_info(api_token, **kwargs)  # noqa: E501

    def v1_auth_login_with_http_info(self, api_token, **kwargs):  # noqa: E501
        """Log In  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.v1_auth_login_with_http_info(api_token, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and local_var_params.get('api_token') is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `api_token` when calling `v1_auth_login`")  # noqa: E501
        ...
        body_params = None
        if 'api_token' in local_var_params:
            body_params = local_var_params['api_token']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
    ...
    def v1_create_hook_with_http_info(self, instance_id, v1_create_hook_parameters, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and local_var_params.get('v1_create_hook_parameters') is None:  # noqa: E501
    ...
    def v1_create_image_with_http_info(self, type, encoding, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and local_var_params.get('encoding') is None:  # noqa: E501
    ...
    def v1_create_instance_with_http_info(self, instance_create_options, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and local_var_params.get('instance_create_options') is None:  # noqa: E501
    ...
    def v1_create_snapshot_with_http_info(self, instance_id, snapshot_creation_options, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and local_var_params.get('snapshot_creation_options') is None:  # noqa: E501
    ...
    def v1_create_subscriber_invite(self, subscriber_invite, **kwargs):  # noqa: E501
        ...
        :param subscriber_invite: Payload of Subscriber Invite (required)
        :type subscriber_invite: SubscriberInvite
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: SubscriberInvite
        """
        kwargs['_return_http_data_only'] = True
        return self.v1_create_subscriber_invite_with_http_info(subscriber_invite, **kwargs)  # noqa: E501

    def v1_create_subscriber_invite_with_http_info(self, subscriber_invite, **kwargs):  # noqa: E501
        """Create Subscriber Invite  # noqa: E501
        ...
        >>> thread = api.v1_create_subscriber_invite_with_http_info(subscriber_invite, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(SubscriberInvite, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v1_create_subscriber_invite" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'subscriber_invite' is set
        if self.api_client.client_side_validation and local_var_params.get('subscriber_invite') is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `subscriber_invite` when calling `v1_create_subscriber_invite`")  # noqa: E501
        ...
        body_params = None
        if 'subscriber_invite' in local_var_params:
            body_params = local_var_params['subscriber_invite']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
    ...
    def v1_delete_hook_with_http_info(self, hook_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and local_var_params.get('hook_id') is None:  # noqa: E501
    ...
    def v1_delete_instance_snapshot_with_http_info(self, instance_id, snapshot_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and local_var_params.get('snapshot_id') is None:  # noqa: E501
    ...
    def v1_get_instance_with_http_info(self, instance_id, **kwargs):  # noqa: E501
        ...
        query_params = []
        if local_var_params.get('return_attr') is not None:  # noqa: E501
    ...
    def v1_get_instance_screenshot_with_http_info(self, instance_id, format, **kwargs):  # noqa: E501
        ...
        query_params = []
        if local_var_params.get('scale') is not None:  # noqa: E501
    ...
    def v1_get_model_software_with_http_info(self, model, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and local_var_params.get('model') is None:  # noqa: E501
    ...
    def v1_get_projects_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if local_var_params.get('name') is not None:  # noqa: E501
            query_params.append(('name', local_var_params['name']))  # noqa: E501
        if local_var_params.get('ids_only') is not None:  # noqa: E501
    ...
    def v1_media_play_with_http_info(self, instance_id, media_play_body, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and local_var_params.get('media_play_body') is None:  # noqa: E501
    ...
    def v1_patch_instance_with_http_info(self, instance_id, patch_instance_options, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and local_var_params.get('patch_instance_options') is None:  # noqa: E501
    ...
    def v1_post_instance_input_with_http_info(self, instance_id, instance_input, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and local_var_params.get('instance_input') is None:  # noqa: E501
    ...
    def v1_remove_project_key_with_http_info(self, project_id, key_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and local_var_params.get('key_id') is None:  # noqa: E501
    ...
    def v1_set_instance_gpios_with_http_info(self, instance_id, gpios_state, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and local_var_params.get('gpios_state') is None:  # noqa: E501
    ...
    def v1_set_instance_peripherals_with_http_info(self, instance_id, peripherals_data, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and local_var_params.get('peripherals_data') is None:  # noqa: E501
    ...
    def v1_set_instance_state_with_http_info(self, instance_id, v1_set_state_body, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and local_var_params.get('v1_set_state_body') is None:  # noqa: E501
    ...
    def v1_start_hyper_trace_with_http_info(self, instance_id, btrace_enable_options, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and local_var_params.get('btrace_enable_options') is None:  # noqa: E501
    ...
    def v1_team_change_with_http_info(self, team_id, create_team, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and local_var_params.get('create_team') is None:  # noqa: E501
    ...
    def v1_update_hook(self, hook_id, v1_create_hook_parameters, **kwargs):  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.v1_update_hook_with_http_info(hook_id, v1_create_hook_parameters, **kwargs)  # noqa: E501

    def v1_update_hook_with_http_info(self, hook_id, v1_create_hook_parameters, **kwargs):  # noqa: E501
        """Update an existing hypervisor hook  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.v1_update_hook_with_http_info(hook_id, v1_create_hook_parameters, async_req=True)
        >>> result = thread.get()
        ...
        # verify the required parameter 'v1_create_hook_parameters' is set
        if self.api_client.client_side_validation and local_var_params.get('v1_create_hook_parameters') is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `v1_create_hook_parameters` when calling `v1_update_hook`")  # noqa: E501
    ...
    def v1_update_project_settings_with_http_info(self, project_id, project_settings, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and local_var_params.get('project_settings') is None:  # noqa: E501
    ...
    def v1_web_player_create_session_with_http_info(self, web_player_create_session_request, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and local_var_params.get('web_player_create_session_request') is None:  # noqa: E501
    ...
    def v1_web_player_destroy_session(self, session_id, **kwargs):  # noqa: E501
        ...
        :param session_id: Web Player Session identifier (required)
        :type session_id: str
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
