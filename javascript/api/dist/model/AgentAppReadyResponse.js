 ...
 * @version 1.0.2
 */
var AgentAppReadyResponse = /*#__PURE__*/function () {
  /**
   ...
   * @param ready {Boolean} 
   */
  function AgentAppReadyResponse(ready) {
    _classCallCheck(this, AgentAppReadyResponse);
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('ready')) {
          obj['ready'] = _ApiClient["default"].convertToType(data['ready'], 'Boolean');
        }
      }
      return obj;
    }
