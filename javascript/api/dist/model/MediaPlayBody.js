 ...
 * @version 1.0.2
 */
var MediaPlayBody = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>MediaPlayBody</code>.
   * 
   * @alias module:model/MediaPlayBody
   */
  function MediaPlayBody() {
    _classCallCheck(this, MediaPlayBody);
   ...
   */
  _createClass(MediaPlayBody, null, [{
    key: "initialize",
