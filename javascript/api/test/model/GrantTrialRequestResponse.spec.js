...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AvhApi.GrantTrialRequestResponse();
  });
  ...
  describe('GrantTrialRequestResponse', function() {
    it('should create an instance of GrantTrialRequestResponse', function() {
      ...
      //var instance = new AvhApi.GrantTrialRequestResponse();
      //expect(instance).to.be.a(AvhApi.GrantTrialRequestResponse);
    });
