...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AvhApi.V1LoadExtensionParameters();
  });
  ...
  describe('V1LoadExtensionParameters', function() {
    it('should create an instance of V1LoadExtensionParameters', function() {
      ...
      //var instance = new AvhApi.V1LoadExtensionParameters();
      //expect(instance).to.be.a(AvhApi.V1LoadExtensionParameters);
    });
