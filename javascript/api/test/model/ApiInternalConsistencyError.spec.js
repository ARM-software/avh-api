...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AvhApi.ApiInternalConsistencyError();
  });
  ...
  describe('ApiInternalConsistencyError', function() {
    it('should create an instance of ApiInternalConsistencyError', function() {
      ...
      //var instance = new AvhApi.ApiInternalConsistencyError();
      //expect(instance).to.be.a(AvhApi.ApiInternalConsistencyError);
    });
