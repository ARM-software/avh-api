...
#ifndef _agent_apps_list_H_
#define _agent_apps_list_H_
...
typedef struct agent_apps_list_t agent_apps_list_t;

#include "agent_app.h"



typedef struct agent_apps_list_t {
